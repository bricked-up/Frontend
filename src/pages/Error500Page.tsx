 ...
 * Error500 Component
 *
 * This component displays a 500 Internal Server Error page using a design
 * that matches the provided CSS. It includes the NavBar and uses the theme's
 * background so that the look adapts to the current theme.
 *
 * @component
 * @example
 * return (
...
const Error500Page: React.FC = () => {
  ...
  const svgBackgroundColor = theme.palette.mode === 'dark' ? "#131b2d" : "#f2f0f0";
  const svgColor = theme.palette.mode === 'dark' ? "#f2f0f0" : "#131b2d";
  return (
    <div
      style={{
        display: "flex",
      ...
      <div className="main-error-page">
        ...
        >
          <defs>
            ...
            <path
              id="prefix__A"
              d="M.007 2.613c-.119 1.303.844 2.459 2.155 2.582 1.311.122 2.472-.835 2.593-2.138.12-1.304-.843-2.46-2.154-2.582-.077-.009-.153-.011-.227-.011-1.216 0-2.253.92-2.367 2.149z"
            />
            <path
              id="prefix__C"
          ...
          <g fill="none" fillRule="evenodd">
            <path fill={svgBackgroundColor} d="M0 0H1366V800H0z" transform="translate(-448 -158)" />
            <g>
              <g transform="translate(-448 -158) translate(448 157) translate(0 .61)">
                <mask id="prefix__b" fill={svgBackgroundColor}>
              ...
              <g className="pao-atras"> <g
                transform="translate(-448 -158) translate(448 157) translate(340 170)">
                <path
                  fill="#E6A95F"
                  d="M5.214 5.34c-.85 3.38 1.072 5.145 5.14 11.15L.464 55.893l44.419 11.492 9.888-39.401c6.384-3.286 8.919-3.909 9.77-7.295.793-3.159-1.093-6.383-4.206-7.189L12.294 1.071c-.48-.125-.962-.185-1.437-.185-2.598 0-4.972 1.783-5.643 4.453z"
                />
              ...
              <g className="pao-frente">
                ...
                <g transform="translate(-448 -158) translate(448 157) translate(344.301 197.242)">
                  <circle
                    ...
                    cx="5"
                    cy="0"
                    r="2" // radius 5 units; adjust as needed
                  />
                </g>
                <g
                ...
                <g
                  transform="translate(-448 -158) translate(448 157) translate(350.495 206.834) rotate(10)"
                >
                  <mask id="prefix__D">
                    <use xlinkHref="#prefix__C" />
                  </mask>
        ...
        <h1 className="error-title" style={{ color: theme.palette.text.secondary }}>
          Woops! <br />Something went wrong :(
        </h1>
        <h2 className="error-subtitle" style={{ color: theme.palette.text.secondary }}>
